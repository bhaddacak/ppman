...
In this tool, all suttas taken from the grammar books and their main commentaries are listed. These books are Kaccāyanabyākara (Kacc or k) with Padarūpasiddhi (Rūpa or r), Moggallānabyākara (Mogg or m) with Payogasiddhi (Payo or p) and Niruttidīpanī (Niru or n), and Saddanīti Suttamālā (Sadd-Sut or s), totally 5,265 suttas in 6 books.\footnote{The majority of suttas in each school are repeated in their commentaries, slightly different sometimes. And some suttas are equivalent across schools. So, total distinct suttas are not so many (but still numeruous to remember them all).}
...
\newpage
\boxnote{Numbering in Kaccāyana\label{box:kaccnumber}\\
\hspace{5mm}\bullet\ In the recent edition of Kaccāyanabyākara by the author, the sutta numbers in this book has been changed to accommodate two numbering schemes differently found in Myanmar edition (having 673 suttas totally) and others (having 675).\\
\hspace{5mm}\bullet\ The running numbers now have dual form separated by a colon, starting with \emph{1:1} to \emph{243:243, 244:x, 245:x, 246:244,} \ldots, \emph{675:673} (the second numbers are of Myanmar edition; `x' marks an absence)\\
\hspace{5mm}\bullet\ Hence, in the Myanmar edition, suttas \emph{244:x} and \emph{245:x} are absent.\\
\hspace{5mm}\bullet\ Now in each sutta of Padarūpasiddhi, the reference to Kacc in that scheme is also added.\\
\hspace{5mm}\bullet\ For further learning of Kacc, see \emph{Grammatical Suttas of Kaccāyana} by the author.\footnote{bhaddacak.github.io/ksut}
}
