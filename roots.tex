...
Roots listed here come from the compilation of Ven.\ U Silana\-nda in \emph{Pali Roots in Saddanīti Dhātu-Mālā compared with Pāṇinīya-Dhātupāṭha}.\footnote{Edited by U Nandisena, available at \url{archive.org/details/ThePaliRoots\-InSaddaniti}} So, the roots are familiar to those who follow Kaccāyana/Saddanīti school.
...
The best way to study these roots, I suggest, is to read Saddanīti Dhātumālā (available in the collection of traditional grammar books) directly on the root you are interested in. In addition, DPD also has its root list, which uses more generic names. It is a good idea to check against that list as well. 

Furthermore, equipped with \textsc{Pāli\,Platform\,3}, {\faSix \symbol{"F002}} Pali Root Finder gives you the most exhaustive list of roots (see Chapter \ref{chap:rootfinder}).
