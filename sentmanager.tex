...
\caption{Tab Sentences in Sentence Manager}
...
\caption{When a sequence is selected}
...
\caption{Statistics showing a sentence reused in sequences}
...
The Variants tab is a lot simpler (see Figure \ref{fig:sentmanager-variants}). All variants and their information are shown here. You can add a new variant by {\faSix \symbol{"F067}} button. This addition is compulsory when you insert a translation into sentences. You can also hide variants you do not want to see in the translations with {\faSix \symbol{"F070}} button. This can make the display less clustered.

\begin{figure}[!hbt]
\centering
\includegraphics[width=0.9\linewidth]{images/sentmanager-variants.png}\\
\caption{Tab Translation Variants in Sentence Manager}
...
\caption{Tab Merger in Sentence Manager}
